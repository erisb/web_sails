      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top pr-5 pl-5">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <h3 class=""><span class="tim-note">Vessel Ops Realization</span></h3>
          </div>
                ...
                <div class="row mr-3">
                  ...
                  <div class="col-6">
                    ...
                    <form>
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter vessel name" disabled>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Call Sign</label>
                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter call sign" disabled>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter" disabled>
                      </div>
                  ...
                  <div class="col-6">
                    <div class="row">
                      <div class="col-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" disabled>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" id="inputGroupSelect01" disabled>
                  ...
                  <!-- Estimation Schedule -->
                  <div id="realization" class="col-12">
                    ...
                    <div class="row">
                      <div class="col-6">
                        <div class="form-group date" data-provide="datepicker">
                          ...
                          <div class="input-group">
                            <input id="datepickereta" class="form-control" data-date-format="mm/dd/yyyy" value="{{ date('m-d-Y') }}" autofocus>
                          </div>
                        </div>
                      </div>
                      <div class="col-6">
                    ...
                    <div class="row">
                      <div class="col-6">
                        ...
                        <form>
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter origin port" disabled>
                          </div>
                      ...
                      <div class="col-6">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter next port" disabled>
                        </div>
                      </div>
                    </div>
                    <!-- ./end row -->
