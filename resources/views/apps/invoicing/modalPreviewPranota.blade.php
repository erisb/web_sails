<!-- Modal Delete -->
<div class="modal fade" id="previewPranota" tabindex="-1" role="dialog" aria-labelledby="previewPranota" aria-hidden="true">
        ...
        <div class="container">
          ...
          <div class="col-12">
            ...
            <div class="table-responsive">
              <table class="table display table-hover cell-border compact stripe">
              ...
              <div class="">
                <div class="d-flex flex-row justify-content-end my-flex-container">
                    <div class="p-2 my-flex-item ml-2">
                      <h4>TOTAL Rp. 1.100.000</h4>
                    </div>
