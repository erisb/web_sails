...
<body>
  <div class="wrapper ">
      ...
      <div class="sidebar-wrapper">
        ...
        <ul class="nav">
          <li  data-toggle="collapse" data-target="#account" class="collapsed">
              <a class="nav-link" href="{{url('web_sl/vesSchedule')}}">
          ...
          <li  data-toggle="collapse" data-target="#account" class="collapsed">
              <a class="nav-link" href="{{url('web_sl/invoiceSL')}}">
                <i class="material-icons">settings</i>
                <p>INVOICE</p>
                <span class="arrow"></span>
              </a>
          ...
          <li  data-toggle="collapse" data-target="#account" class="collapsed">
              <a class="nav-link" href="{{url('web_sl/userSL')}}">
                <i class="material-icons">settings</i>
                <p>USERS</p>
                <span class="arrow"></span>
              </a>
          ...
          <li  data-toggle="collapse" data-target="#account" class="collapsed">
              <a class="nav-link" href="{{url('logout_sl')}}">
    ...
    @yield('content')
    @yield('modal_ves_schedule')
    @yield('modal_ves_service')
    @yield('modal_user_sl')
    @stack('scriptJS')
    @extends('web_sl.mains.footer_sl')
